...
namespace SV22T1020674.BusinessLayers
{
    ...
    public static class HRDataService
    {
        ...
        public static async Task<Employee?> AuthorizeAsync(string username, string password)
        {
            return await employeeDB.AuthorizeAsync(username, password);
        }
        public static async Task<bool> UpdatePasswordAsync(int employeeId, string newPassword)
        {
            return await employeeDB.UpdatePasswordAsync(employeeId, newPassword);
        }
